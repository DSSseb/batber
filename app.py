...
with col3:
    ...
    <div>Største trin hvor den ekstra kapacitet stadig er både teknisk og økonomisk rimeligt udnyttet.</div></div>""",
        unsafe_allow_html=True,
    )
...
st.caption(
    ...
    "og marginal økonomisk effektivitet. Lade-/afladeeffekt tilføjes senere, når effektdata er komplette."
)
